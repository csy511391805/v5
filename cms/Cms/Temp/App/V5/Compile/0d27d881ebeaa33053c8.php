...
PUBLIC = '<?php echo $GLOBALS['user']['PUBLIC'];?>';
		...
		<script type="text/javascript" src="http://127.0.0.1/v5/cms/Cms/App/V5/Tpl/Index/js/menu.js"></script>
		<script type="text/javascript" src="http://127.0.0.1/v5/cms/Cms/App/V5/Tpl/Index/js/quick_menu.js"></script>
		<link type="text/css" rel="stylesheet" href="http://127.0.0.1/v5/cms/Cms/App/V5/Tpl/Index/css/css.css"/>
		<link type="text/css" rel="stylesheet" href="http://127.0.0.1/v5/cms/Cms/App/V5/Tpl/Index/css/quick_menu.css"/>
	</head>
	<body>
		<div class="nav">
			<!--头部左侧导航-->
...
echo "";
			...
			<div class="r_menu">
				...
				<span>|</span>
				<a href="http://127.0.0.1/v5/cms/index.php" target="_blank">
					前台首页
				</a>
				<span>|</span>
