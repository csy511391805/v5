...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>        
        ...
        <link href='http://127.0.0.1/v5/cms/hdphp/setup/./Tpl/State/Css/setup.css' rel='stylesheet' type='text/css'/>
...
<body>
    <div class="hd_setup">
        ...
        <h2>
            <a href="http://127.0.0.1/v5/cms/hdphp/setup/index.php?c=Session" class="home">返回安装首页</a>
            <a href="javascript:void(0)"  class="home" onclick="window.close();return false;">关闭</a>
            <a href="http://127.0.0.1/v5/cms/hdphp/setup/index.php/rbac/lock" class="home">锁定SETUP应用</a>
        </h2>
    </div>
    <div class="setup">
        ...
        <dl>
            <dt>SESSION表配置</dt>
            <dd><a href="http://127.0.0.1/v5/cms/hdphp/setup/index.php/rbac/setconfig" target="_blank">配置表参数</a></dd>
            <dd><a href="http://127.0.0.1/v5/cms/hdphp/setup/index.php/session/createsessiontable" target="_self">安装SESSION数据库表</a></dd>
        </dl>
    </div>
